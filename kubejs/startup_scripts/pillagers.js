...
attribute.add("minecraft:generic.movement_speed", 0.82)
...
attribute.add("minecraft:generic.follow_range", 64)
attribute.add("minecraft:generic.movement_speed", 0.76)
...
attribute.add("minecraft:generic.follow_range", 64)
attribute.add("minecraft:generic.movement_speed", 0.7)
attribute.add("minecraft:generic.armor", 4)
    })
